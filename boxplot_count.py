...
Needle_19 = np.array(np.load("Needle_Count_19.npy",  allow_pickle=True))
Needle_23 = np.array(np.load("Needle_Count_23.npy",  allow_pickle=True))
Needle_39 = np.array(np.load("Needle_Count_39.npy",  allow_pickle=True))
...
colors = ['#00429d', '#3761ab', '#73a2c6', '#93c4d2', '#b9e5dd']
colors = ['#004c6d','#007ab3','#fec44f','#d95f0e','#a50f15']
...
bpl = plt.boxplot(kallisto, positions=np.array(range(len(ticks)))*2.0-0.4, sym='', widths=0.2)
bpr = plt.boxplot(salmon, positions=np.array(range(len(ticks)))*2.0-0.2, sym='', widths=0.2)
bp0 = plt.boxplot(Needle_19, positions=np.array(range(len(ticks)))*2.0+0.2, sym='', widths=0.2)
bp1 = plt.boxplot(Needle_23, positions=np.array(range(len(ticks)))*2.0+0.4, sym='', widths=0.2)
bp2 = plt.boxplot(Needle_39, positions=np.array(range(len(ticks)))*2.0+0.6, sym='', widths=0.2)
...
plt.plot([], c=colors[2], label='Needle (19, 19)')
plt.plot([], c=colors[3], label='Needle (23, 19)')
plt.plot([], c=colors[4], label='Needle (39, 19)')
plt.legend()
...
Needle_19 = np.array(np.load("Needle_Count_19_Cov.npy",  allow_pickle=True))
Needle_23 = np.array(np.load("Needle_Count_23_Cov.npy",  allow_pickle=True))
Needle_39 = np.array(np.load("Needle_Count_39_Cov.npy",  allow_pickle=True))
...
bpl = plt.boxplot([kallisto[0], kallisto[1], kallisto[2], kallisto[3], kallisto[4], kallisto[5]], positions=np.array(range(len(ticks)))*2.0-0.4, sym='', widths=0.2)
bpr = plt.boxplot([salmon[0], salmon[1], salmon[2], salmon[3], salmon[4], salmon[5]], positions=np.array(range(len(ticks)))*2.0-0.2, sym='', widths=0.2)
...
set_box_color(bpl, colors[0])
set_box_color(bpr, colors[1])
set_box_color(bp1, colors[2])
set_box_color(bp2, colors[3])
set_box_color(bp3, colors[4])
